...
이것을 테스트하기 위한 메인함수가 동봉되어 있습니다.

## 왜 만들었는가
이야기는 2011년, 김상병이었던 시절로 거슬러 갑니다. 건축학도로서 맨날 써 온 캐드가 어떻게 작동하는지, 열심히 하던 게임들은 어떻게 만드는지 문득 궁금해서 프로그래밍 공부를 시작했습니다. 그때 화면에 점 찍는 법만 누가 알려준다면 3차원을 구현해 볼 수 있을 것 같다는 생각을 했었는데, 그땐 얻을 수 있는 자료가 너무 한정적이어서 프로그래밍의 맛만 보고 끝났습니다.
...
# 사용한 오픈소스
1. Assimp[http://assimp.org/]

2. Stb Image[https://github.com/nothings/stb]